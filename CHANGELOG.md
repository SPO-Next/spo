...
- Write [specification for spo URIs](https://github.com/spo-next/spo#uri-specification) (based upon bip21)
...
- For electron clients, download a list of peers from https://downloads.spo.net/blockchain/peers.txt by default
...
- Add `/logs` api to filter spo logs, so that we can add a debug panel to the GUI wallet to show logs
...
- CLI's `walletHistory` command prints amounts as fixed-point decimal strings. Previously, it printed amounts as integers representing whole spo amounts, and did not support droplets / fractional spos.
...
[Unreleased]: https://github.com/spo-next/spo/compare/master...develop
[0.23.0]: https://github.com/spo-next/spo/compare/v0.22.0...v0.23.0
[0.22.0]: https://github.com/spo-next/spo/compare/v0.21.1...v0.22.0
[0.21.1]: https://github.com/spo-next/spo/compare/v0.21.0...v0.21.1
[0.21.0]: https://github.com/spo-next/spo/compare/v0.20.4...v0.21.0
[0.20.4]: https://github.com/spo-next/spo/compare/v0.20.3...v0.20.4
[0.20.3]: https://github.com/spo-next/spo/compare/v0.20.2...v0.20.3
[0.20.2]: https://github.com/spo-next/spo/compare/v0.20.1...v0.20.2
[0.20.1]: https://github.com/spo-next/spo/compare/v0.20.0...v0.20.1
[0.20.0]: https://github.com/spo-next/spo/compare/v0.19.1...v0.20.0
[0.19.1]: https://github.com/spo-next/spo/compare/v0.19.0...v0.19.1
[0.19.0]: https://github.com/spo-next/spo/commit/dd924e1f2de8fab945e05b3245dbeabf267f2910
