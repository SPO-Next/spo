...
import (
	...
	"github.com/spo-next/spo/src/util/droplet" //http,json helpers
	"github.com/spo-next/spo/src/util/fee"
...
Set SKYCOIN_NODE_HOST to the node's address (defaults to http://127.0.0.1:8620)
