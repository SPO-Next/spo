...
import (
	...
	wh "github.com/spo-next/spo/src/util/http" //http,json helpers
)
...
func injectTransaction(gateway Gatewayer) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// TODO -- move this to a more general verification layer, see https://github.com/spo-next/spo/issues/1342
