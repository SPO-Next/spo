...
The SPO web interface requires Node 6.9.0 or higher, together with NPM 3 or higher.
...
While event.spo.network is not working, we will have to run the purchase API locally.
